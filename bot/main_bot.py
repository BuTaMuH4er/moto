...
if __name__ == '__main__':
    ...
    dp.add_handler(CallbackQueryHandler(logic.show_list_motocycles, pass_user_data=True, pattern='^' + 'back_list_motocycle|next_list_motocycle' + '$'))
    dp.add_handler(CallbackQueryHandler(logic.show_motocycle, pattern='\d'))
